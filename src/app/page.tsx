...
const COPY = {
  ...
  about: {
    ...
    elig: {
      ...
      note: "ملاحظة مهمة: لا يُشترط تقديم اختبار IELTS أو أي اختبار لغة إنجليزية للتقديم على منحة شيفنينغ. الاختبار مطلوب فقط للجامعات بعد قبول المنحة. سيكون مطلوباً في يونيو 2027, بعد سنة من الآن.",
    },
  },
  alert: {
  ...
  mentor: {
    ...
    rows: [
      ...
      { ic: "📚", t: "7 سنوات من الخبرة في توجيه طلاب شيفنينغ" },
  ...
  included: {
    ...
    features: [
      ...
      "خطة التحضير من الآن حتى أكتوبر",
  ...
  methodology: {
    title: "منهجية التحضير الشاملة (يونيو, أكتوبر 2026)",
    sub: "خطة العمل الشهرية المفصلة",
    months: [
      {
        h: "يونيو & يوليو 2026, شهر الأسس",
        accent: "blue",
        items: [
      ...
      {
        h: "أكتوبر 2026, المراجعة والتقديم",
        accent: "green",
        items: [
  ...
  schedule: {
    ...
    rows: [
      "يونيو 2026: بداية البرنامج, أول اجتماع فردي",
      "أغسطس 2026: فتح التقديم لمنحة شيفنينغ",
      "أكتوبر 2026: آخر موعد للتقديم, نهاية البرنامج",
    ],
  },
  commit: {
    ...
    payItems: [
      ...
      "لا يمكن استرداد الرسوم بعد بداية البرنامج في 1 يونيو 2026",
...
const PERSONAL_FIELDS = [
  ...
  { id: "ig", label: "حساب الإنستغرام", req: true, kind: "input" as const, placeholder: "@username أو رابط الحساب" },
    ...
    <div className="chev">
      <div className="chev-wrap">
        ...
        <FormSection
          ...
          banner="📢 معلومة مهمة عن اللغة الإنجليزية: شيفنينغ لا تتطلب اختبار لغة إنجليزية للتقديم! سنقدم طلبك كاملاً بدون أي متطلب للغة الإنجليزية. اختبار اللغة مطلوب فقط للجامعات في يونيو 2027 (بعد سنة من الآن)"
